                  ...
                  {category.skills.map((skill) => (
                    <Tooltip key={skill}>
                      <TooltipTrigger asChild>
                        <div className="relative group flex h-16 w-16 cursor-pointer items-center justify-center overflow-hidden rounded-lg bg-card/60 p-3 transition-all duration-300 hover:bg-card/90">
                          {skillIcons[skill]}
