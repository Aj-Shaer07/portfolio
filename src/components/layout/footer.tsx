      ...
      <div className="container py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-foreground/80">A portfolio built with Next.js, Tailwind CSS, and GenAI.</p>
          </div>
          <div>
            <h4 className="text-lg font-semibold font-headline mb-4">Contact Me</h4>
            <div className="flex items-center space-x-3">
              <Mail className="w-5 h-5" />
              <a href="mailto:hello@reactfolio.com" className="hover:underline text-foreground/80">
